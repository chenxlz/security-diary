...
[传送门](https://juejin.cn/post/7174282119647068196?searchId=20240523201152A635F2A1B856FF8F8619#heading-1)
...
1. 直接侦听对象，开启deep：true，新旧值都是同一个：**官网说是变更对象、数组元素时候，不是替换的情况下，新旧值相同，他们指向同一个对象、数组，vue不会保留变更前的副本**
2. 解决这个问题，可以使用计算函数，计算函数直接返回深拷贝的对象，
